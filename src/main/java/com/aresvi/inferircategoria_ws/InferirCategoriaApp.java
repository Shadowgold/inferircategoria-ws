...
public class InferirCategoriaApp {

	private static Logger log = LoggerFactory.getLogger(InferirCategoriaApp.class);

    public static void main(String[] args) {
        ApplicationContext ctx = SpringApplication.run(InferirCategoriaApp.class, args); 
